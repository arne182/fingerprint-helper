...
def find_matches(unsupported_fp=""):
    makes = [fingerprints.TOYOTA_FINGERPRINTS, fingerprints.GM_FINGERPRINTS, fingerprints.FORD_FINGERPRINTS, fingerprints.HONDA_FINGERPRINTS, fingerprints.CHRYSLER_FINGERPRINTS, fingerprints.HYUNDAI_FINGERPRINTS, fingerprints.SUBARU_FINGERPRINTS, fingeprints.VW_FINGERPRINTS]
    if unsupported_fp == "":
